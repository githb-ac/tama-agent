...
final class ClaudeService {
    ...
    - **browser automation**: use `browser` to navigate sites, click, type, extract content, evaluate JS, and take screenshots
    - **screenshots**: use `browser` with action "screenshot" to capture pages — useful for visual verification, sharing what you see, or debugging
